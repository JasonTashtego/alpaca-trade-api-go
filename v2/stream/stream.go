...
//func SubscribeBars(cApiKey * common.APIKey, handler func(bar Bar), symbols ...string) error {
//	initStreamsOnce()
//	dataStream.apiKey = cApiKey
...
//func SubscribeTradeUpdates(ky *common.APIKey,  handler func(update alpaca.TradeUpdate)) error {
//	initStreamsOnce()
//	return alpacaStream.Subscribe(ky, alpaca.TradeUpdates, func(msg interface{}) {
